          ...
          return (
            <button
              ...
              className={cn(
                ...
                isSelected
                  ? "bg-primary text-white shadow-[0_0_20px_hsla(var(--primary)/0.4)] scale-110"
                  : "bg-card/50 border-2 border-border text-foreground hover:border-primary/50 hover:bg-card/70 dark:border-white/10"
              )}
            >
              <div className="flex flex-col items-center justify-center gap-2 h-full">
                <Star
                  className={cn(
                    ...
                    isSelected
                      ? "fill-current text-white animate-in zoom-in"
