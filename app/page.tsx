...
import { ArrowRight, Clock, Target, TrendingUp, Sparkles, Users, Shield } from "lucide-react"
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-muted/10 relative overflow-hidden">
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-gradient-to-br from-green-400/10 to-cyan-400/10 rounded-full blur-3xl animate-pulse delay-2000"></div>

        {/* Partículas flotantes */}
        <div className="absolute top-20 left-20 w-2 h-2 bg-orange-400/40 rounded-full animate-bounce delay-300"></div>
        <div className="absolute top-40 right-32 w-1 h-1 bg-red-400/40 rounded-full animate-bounce delay-700"></div>
        <div className="absolute bottom-32 left-1/4 w-1.5 h-1.5 bg-blue-400/40 rounded-full animate-bounce delay-1100"></div>
        <div className="absolute bottom-20 right-20 w-2 h-2 bg-purple-400/40 rounded-full animate-bounce delay-1500"></div>
      </div>
      ...
      <main className="container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 lg:py-16 relative z-10">
        ...
        <div className="text-center space-y-4 sm:space-y-6 mb-12 sm:mb-16">
          <div className="space-y-3 sm:space-y-4">
            <div className="inline-flex items-center px-4 py-2 rounded-full bg-gradient-to-r from-orange-100 to-red-100 dark:from-orange-900/30 dark:to-red-900/30 border border-orange-200 dark:border-orange-800 mb-4 animate-in slide-in-from-top-4 duration-1000 hover:scale-105 transition-transform">
              <Sparkles className="h-4 w-4 text-orange-600 mr-2 animate-pulse" />
              <span className="text-sm font-medium text-orange-700 dark:text-orange-300">
                Descubre tu estrategia crypto ideal
              </span>
            </div>

            <h1 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold bg-gradient-to-r from-orange-600 via-red-600 to-pink-600 bg-clip-text text-transparent leading-tight animate-in slide-in-from-bottom-4 duration-1000 hover:scale-105 transition-transform cursor-default">
              Encuentra Tu Estrategia
              <br />
              <span className="relative">
                Crypto Perfecta
                <div className="absolute -bottom-2 left-1/2 transform -translate-x-1/2 w-24 h-1 bg-gradient-to-r from-orange-500 to-red-500 rounded-full animate-in slide-in-from-left duration-1000 delay-500 animate-pulse"></div>
              </span>
            </h1>

            <p className="text-sm sm:text-base text-muted-foreground max-w-lg mx-auto leading-relaxed px-4 animate-in slide-in-from-bottom-4 duration-1000 delay-200 hover:text-foreground/80 transition-colors">
              Toma nuestro quiz personalizado para descubrir qué enfoque de criptomonedas se adapta a tus objetivos,
              tolerancia al riesgo y nivel de experiencia.
            </p>
          </div>

          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center px-4 animate-in slide-in-from-bottom-4 duration-1000 delay-300">
            <Link href="/quiz">
              <Button
                size="lg"
                className="bg-gradient-to-r from-orange-600 to-red-600 hover:from-orange-700 hover:to-red-700 text-white px-6 sm:px-8 py-4 sm:py-6 text-base sm:text-lg font-semibold rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 w-full sm:w-auto group hover:scale-105 hover:-translate-y-1"
              >
                Comenzar Quiz
                <ArrowRight className="ml-2 h-4 w-4 sm:h-5 sm:w-5 group-hover:translate-x-1 transition-transform duration-200 animate-pulse" />
              </Button>
            </Link>
            <div className="flex items-center text-sm text-muted-foreground bg-muted/50 px-4 py-2 rounded-full hover:bg-muted/70 transition-colors animate-pulse">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-12 sm:mb-16 px-4">
          <Card className="relative overflow-hidden bg-gradient-to-br from-card via-card to-card/80 border-0 shadow-xl hover:shadow-2xl transition-all duration-500 hover:scale-105 hover:-translate-y-3 animate-in slide-in-from-bottom-4 duration-1000 delay-700 group backdrop-blur-sm">
          ...
          <Card className="relative overflow-hidden bg-gradient-to-br from-card via-card to-card/80 border-0 shadow-xl hover:shadow-2xl transition-all duration-500 hover:scale-105 hover:-translate-y-3 animate-in slide-in-from-bottom-4 duration-1000 delay-800 group backdrop-blur-sm">
            ...
            <CardContent className="p-6 sm:p-8 text-center space-y-4 relative z-10">
              ...
              <p className="text-muted-foreground text-sm leading-relaxed">
                Basado en estrategias probadas y condiciones actuales del mercado
              </p>
            </CardContent>
          </Card>

          <Card className="relative overflow-hidden bg-gradient-to-br from-card via-card to-card/80 border-0 shadow-xl hover:shadow-2xl transition-all duration-500 hover:scale-105 hover:-translate-y-3 sm:col-span-2 lg:col-span-1 animate-in slide-in-from-bottom-4 duration-1000 delay-900 group backdrop-blur-sm">
